  ...
  return (
    <React.Fragment>
      <Col md="10">
        ...
        <p>
          You can see what other you posted, edit and delete whatcha need to.
          Keep your work buddies in check, and help guide them the right way
          with goodconstructive criticism and gentle banter. Feel free to make
          changes to your own content and view what other's wrote about the Rick
          and Morty cast.
        </p>
      </Col>
      <Col md="12">
